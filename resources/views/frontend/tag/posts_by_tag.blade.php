...
@endsection
@section('breadcrumb')
{{ Breadcrumbs::view('breadcrumbs::json-ld', 'postsByTag',$tag) }}
@endsection
@section('content')
<div class="breadcrumb">
	<div class="container">
        {{ Breadcrumbs::render('postsByTag', $tag) }}
                    ...
                    <div class="sidebar-widget product-tag wow fadeInUp">
                        ...
                        <div class="sidebar-widget-body outer-top-xs">
                            <div class="tag-list">
                                ...
                                <a class="item {{ $postTag->id==$tag->id?'active':'' }}" title="Vest" href="{{ route('tags.posts.show', $postTag) }}">{{ $postTag->name }}</a>
                                @endforeach

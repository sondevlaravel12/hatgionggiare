...
<script>
    ...
    $('#edit-sample-modal').on('click','#btn-save-edit-sample', function () {
        ...
        updateSampe($sampleId,$sampleTitle, $sampleDescriptionVal).done(function(data){
    ...
    function updateSampe(sampleId, sampleTitle, sampleDescription){
        // return the ajax promise
        return $.ajax({
            type: "get",
            url: "/superadmin/ajax-update-sample-info",
            data: {id:sampleId, title:sampleTitle, description:sampleDescription},
            dataType: "json",
        });
    }

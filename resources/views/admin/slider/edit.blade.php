        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('admin.sliders.update', $slider)}}" method="POST" enctype="multipart/form-data">
                    ...
                    @method('PUT')
                    <div class="row mb-3">
                        <label for="example-text-input" class="col-sm-2 col-form-label">Loai</label>
                        <div class="col-sm-10">
                    ...
                    <div id="slider-only">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="link" value="{{old('link') ?? $slider->link}}"  >
                                @error('link')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="button-items">
                        ...
                        <a href="{{route('admin.sliders.index')}}" class="btn btn-light waves-effect waves-light"><span class="fas fa-ban"></span> &nbsp;Cancel</a>
                    </div>
                </form>
            </div>
        </div>
